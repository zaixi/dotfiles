...
let g:term_colorscheme = 'molokai'
"let g:term_colorscheme = 'onedark'
...
if dein#load_state('$HOME/.vim/plug/')
	...
	call dein#add('cpiger/NeoDebug')							    " 中文文档
	call dein#add('pearofducks/ansible-vim')							    " 中文文档
...
" 复制粘贴系统剪贴板
map <leader>y :call system("xclip -i -selection clipboard", getreg("\""))<CR>:call system("xclip -i", getreg("\""))<CR>
...
command Tab2Spa :call Tab2Spa()
command Spa2Tab :call Spa2Tab()
"}}}
"
